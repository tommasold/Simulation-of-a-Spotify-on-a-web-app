...
<body>
	...
	<form action="ScriptNuevoAlbum.php" method="post" class="formulario" style='margin:20pt; background-color:black;color:white;'>
      ...
      <tr>
				<td>image:</td>
				<td><textarea name="image" rows="5" cols="120"></textarea></td>
			</tr>
			<tr>
				<td>fecha:</td>
				<td><input type="text" name="fecha" size="120" /></td>
			</tr>
			<tr>
				<td><input type="hidden" name="idartista" value="<?php $idartista = $_GET['idartista']; echo $idartista; ?>"/></td>
			</tr>
			<tr>
				<td>
